...
public abstract class AbstractTestController {
    ...
    protected News createNews(
            Long id, String title, String text, User user, Category category, Comment comment) {
    ...
    protected NewsWithoutContactsResponse createNewsWithoutContactsResponse(
            String title, String text, Integer countComments, Long userId, Long categoryId) {
    ...
    protected UserResponse createUserResponse(
            String firstName, String secondName, Integer countNewses, Integer countComments) {
    ...
    protected NewsResponse createNewsResponse(
            String title, String text, Long userId, Long categoryId, CommentResponse commentResponse) {
